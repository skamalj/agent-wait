"""`@hitl`: a function becomes interruptible. Both modes, on nodes and on tools, on real
...
def test_calling_a_hitl_function_parks_the_graph_and_publishes_the_call() -> None:
    CALLS.clear()
...
# ============================================================ under @tool
def test_hitl_composes_under_langchain_tool() -> None:
