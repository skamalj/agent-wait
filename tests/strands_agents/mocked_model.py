"""A scripted Strands model: returns pre-defined assistant messages in sequence.

Adapted from the SDK's own test fixture (`strands-py/tests/fixtures/mocked_model_provider.py`,
Apache-2.0) so the tests here drive a real `Agent` through the real tool and interrupt
machinery with no network.
"""
